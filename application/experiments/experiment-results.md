...
The intended state includes information such as:
...
The implementation was corrected, and the final experiment is  recorded as PASS because the behavior has been independently verified.

### Finding

Detailed information about a users action from the start of their session to the end is generated
